...
<div class="container">
	...
	<h3 style="color: red">***请确认电脑或手机的时间是 正确的 日期和时间。</h3>
	<br />
  ...
  <h4>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://github.com/v2ray/v2ray-core/releases/download/v3.18/v2ray-windows-64.zip" download="v2ray-windows-64.zip">64位下载 </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://github.com/v2ray/v2ray-core/releases/download/v3.18/v2ray-windows-32.zip" download="v2ray-windows-32.zip"> 32位下载</a>
  </h4>
  <h4>2.下载后解压，如果没有压缩软件，请点<a href="http://haozip.2345.com/"> 这里 </a>下载</h4>
  ...
  <h3>四、苹果电脑Mac系统 <a href="https://github.com/v2ray/v2ray-core/releases/download/v3.18/v2ray-macos.zip" download="v2ray-macos.zip"> 下载 </a></h3>  
  <h4>打开解压后的文件夹，用上面修改后的 config.json 替换同名文件。</h4>
  <h4>然后打开v2ray，设置socks代理，即可通过浏览器访问google。</h4>
  ...
  <h4>2.安装后的配置文件config.json在/etc/v2ray目录下</h4>
  <h4>3.先停止v2ray</h4>
