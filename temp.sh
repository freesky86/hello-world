...
/usr/bin/v2ray/v2ctl api --server=127.0.0.1:54979 StatsService.GetStats 'name: "user>>>love6503@v2ray.com>>>traffic>>>downlink" reset: false' | grep value >> /etc/v2ray/log/love6503-down.txt

/usr/bin/v2ray/v2ctl api --server=127.0.0.1:54979 StatsService.GetStats 'name: "user>>>g20-6600@v2ray.com>>>traffic>>>downlink" reset: false' | grep value >> /etc/v2ray/log/g20-6600-down.txt
